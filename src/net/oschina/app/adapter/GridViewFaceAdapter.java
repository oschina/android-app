...
public class GridViewFaceAdapter extends BaseAdapter {
	...
	// 定义整型数组 即图片源
	private final static int[] mImageIds = new int[] { R.drawable.f001,
	...
	private static Pattern pattern = Pattern.compile("\\[{1}([0-9]\\d*)\\]{1}");
	 ...
	 * @param content
	 */
	public static void setText(Context context, TextView tx, String content) {
